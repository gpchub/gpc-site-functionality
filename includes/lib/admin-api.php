...
namespace GpcSiteFunctionality\Lib;
...
class Admin_Api {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'gpc-site-functionality' ) . '" data-uploader_button_text="' . __( 'Use image', 'gpc-site-functionality' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'gpc-site-functionality' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'gpc-site-functionality' ) . '" />' . "\n";
	...
	public function display_meta_box_field( $field = array(), $post = null ) {
		...
		$field = '<div class="form-field"><label for="' . $field['id'] . '">' . $field['label'] . '</label><div class="form-control">' . $this->display_field( $field, $post, false ) . '</div></div>' . "\n";
